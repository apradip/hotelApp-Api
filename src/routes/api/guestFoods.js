...
const { handelDetail, handelTableBooking, handelOrder, handelDelivery, handelCheckout } = require("../../controllers/guestFoods");
...
router.route("/:hotelId/:guestId/:transactionId")                        
    ...
    .patch(verifyRoles(ROLE_LIST.SYSTEM_ADMIN, 
                        ROLE_LIST.HOTEL_ADMIN, 
                        ROLE_LIST.KITCHEN_ADMIN,
                        ROLE_LIST.OFFICE_STAFF,
                        ROLE_LIST.RECEPTIONIST,
