...
const { handelSearch, handelDetail, handelOrder, handelDelivery, handelGenerateBill, handelBillDetail, handelCheckout } = require("../../controllers/guestMiscellaneouses");
