  ...
  try {
    if (res) {
      if (res.length === 0) {
        ...
        const fulfillment = `School statics for *${district}* as follows :\n\nTotal no of school : ${total}\n\nNo. of school have up to grade IV : ${class_4}\nNo of school have up to grade V : ${class_5}\nNo. of school have up to grade VIII : ${class_8}\nNo. of school have up to grade X : ${class_10}\nNo. of school have up to grade XII : ${class_12}\n\nNo. of School Type\nCo-ed : ${coed}, Girls : ${girl}, Boys : ${boy}\n\nNo. of School have Toilet\nGirls : ${toilet_g},  Boys : ${toilet_b}\n\nNo. of School have Water : ${water}\nNo. of School have Hand pump : ${hand_pump}\nNo. of School have Whell port : ${whell_port}\nNo. of School have Tap water : ${tap}\nNo. of School have Packet water : ${pack_water}\n\nNo. of School have Hand wash facility : ${hand_wash}\n\nNo. of School have Electricity facility : ${electricity}\n\nNo. of School have Play ground facility : ${play_ground}`;
